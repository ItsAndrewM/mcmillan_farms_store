        ...
        <div className={styles.text}>
          ...
          <ul>
            ...
            <li>
              ...
              in this Agreement) refers to McMillan Farms.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to McMillan Farms, accessible from{" "}
              <a href="https://www.mcmillanfarms.ca/">
                https://www.mcmillanfarms.ca/
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="information@mcmillanfarms.ca">
